...
/**
 * <p>Classe Java pour PostAdminBackgroundActivity.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="PostAdminBackgroundActivity">
 ...
 * 
 */
@XmlType(name = "PostAdminBackgroundActivity")
@XmlEnum
public enum PostAdminBackgroundActivity {
    ...
    PostAdminBackgroundActivity(String v) {
        value = v;
    }
    ...
    public static PostAdminBackgroundActivity fromValue(String v) {
        for (PostAdminBackgroundActivity c: PostAdminBackgroundActivity.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
