...
/**
 * <p>Classe Java pour PreAdminBackgroundActivityUnit.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="PreAdminBackgroundActivityUnit">
 ...
 * 
 */
@XmlType(name = "PreAdminBackgroundActivityUnit")
@XmlEnum
public enum PreAdminBackgroundActivityUnit {
    ...
    PreAdminBackgroundActivityUnit(String v) {
        value = v;
    }
    ...
    public static PreAdminBackgroundActivityUnit fromValue(String v) {
        for (PreAdminBackgroundActivityUnit c: PreAdminBackgroundActivityUnit.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
