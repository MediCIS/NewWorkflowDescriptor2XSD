 ...
 *       &lt;sequence>
 *         &lt;element name="VOIIdentifierUsed" type="{http://www.w3.org/2001/XMLSchema}integer" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class VOIIdentifierContainer {
    ...
    protected List<BigInteger> voiIdentifierUsed;
     ...
     * 
     */
    public List<BigInteger> getVOIIdentifierUsed() {
        if (voiIdentifierUsed == null) {
            voiIdentifierUsed = new ArrayList<BigInteger>();
        }
