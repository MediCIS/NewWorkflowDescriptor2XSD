...
/**
 * <p>Classe Java pour AdministeredActivityUnit.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="AdministeredActivityUnit">
 ...
 * 
 */
@XmlType(name = "AdministeredActivityUnit")
@XmlEnum
public enum AdministeredActivityUnit {
    ...
    AdministeredActivityUnit(String v) {
        value = v;
    }
    ...
    public static AdministeredActivityUnit fromValue(String v) {
        for (AdministeredActivityUnit c: AdministeredActivityUnit.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
