...
/**
 * <p>Classe Java pour PreAdminActivityUnit.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="PreAdminActivityUnit">
 ...
 * 
 */
@XmlType(name = "PreAdminActivityUnit")
@XmlEnum
public enum PreAdminActivityUnit {
    ...
    public static PreAdminActivityUnit fromValue(String v) {
        for (PreAdminActivityUnit c: PreAdminActivityUnit.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
