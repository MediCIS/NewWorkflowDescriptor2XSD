...
/**
 * <p>Classe Java pour PostAdminBackgroundActivityUnit.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <p>
 * <pre>
 * &lt;simpleType name="PostAdminBackgroundActivityUnit">
 ...
 * 
 */
@XmlType(name = "PostAdminBackgroundActivityUnit")
@XmlEnum
public enum PostAdminBackgroundActivityUnit {
    ...
    PostAdminBackgroundActivityUnit(String v) {
        value = v;
    }
    ...
    public static PostAdminBackgroundActivityUnit fromValue(String v) {
        for (PostAdminBackgroundActivityUnit c: PostAdminBackgroundActivityUnit.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
